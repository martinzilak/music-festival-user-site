...
=======
$textarea-box-enclosed-single-outlined-margin-top: 12px !default;
$textarea-enclosed-text-slot-margin: -12px !default;
$textarea-enclosed-text-slot-padding: 12px !default;
$textarea-line-height: 18px !default;
$textarea-min-height: 32px !default;
$textarea-padding: 7px 0 !default;
$textarea-prefix-padding-top: 4px !default;
$textarea-solo-append-padding: 12px !default;
$textarea-solo-append-prepend-margin-top: 16px !default;
